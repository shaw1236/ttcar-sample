...
COMPOSE_FILE_BASE=docker/docker-compose-test-net-persistence.yaml
# docker-compose.yaml file if you are using couchdb
#COMPOSE_FILE_COUCH=docker/docker-compose-couch.yaml
COMPOSE_FILE_COUCH=docker/docker-compose-couch-persistence.yaml
# certificate authorities compose file
#COMPOSE_FILE_CA=docker/docker-compose-ca.yaml
COMPOSE_FILE_CA=docker/docker-compose-ca-persistence.yaml
